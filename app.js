...
window.doLogin = function() {
  ...
  if (!email || !pass) {
    errEl.textContent = 'Please enter email and password · ಇಮೇಲ್ ಮತ್ತು ಪಾಸ್‌ವರ್ಡ್ ನಮೂದಿಸಿ';
  ...
  signInWithEmailAndPassword(auth, email, pass)
    ...
    .catch(err => {
      ...
      if (['auth/invalid-credential','auth/wrong-password','auth/user-not-found'].includes(err.code)) {
        msg = 'Invalid email or password · ತಪ್ಪಾದ ಇಮೇಲ್/ಪಾಸ್‌ವರ್ಡ್';
...
window.doRegister = function() {
  ...
  createUserWithEmailAndPassword(auth, email, pass)
    ...
    .catch(err => {
      ...
      if (err.code === 'auth/email-already-in-use') msg = 'Email already registered · ಈ ಇಮೇಲ್ ಈಗಾಗಲೇ ನೋಂದಣಿ ಆಗಿದೆ';
